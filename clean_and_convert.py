#!/usr/bin/env python3
"""Clean and convert the malformed Next_Day CSV export into proper format."""
...
def main() -> None:
    if len(sys.argv) != 2:
        print("Usage: python clean_and_convert.py /path/to/source.csv")
        sys.exit(1)
    ...
    # Clean up the content: remove excessive whitespace while preserving quotes
    lines = []
    for line in content.split('\n'):
        cleaned = remove_extra_whitespace(line)
        if cleaned:
